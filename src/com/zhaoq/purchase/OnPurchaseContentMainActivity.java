...
public class OnPurchaseContentMainActivity extends Activity {
	private ListView listview;
	private List<WH_StockDetail> list;
	...
	private void initData() {
		...
		Cursor cursor = Select.selectWH_StockDetail(No, Date,
	...
	protected void select() {
		list = new ArrayList<WH_StockDetail>();
		...
		while (cursor.moveToNext()) {
			...
			list.add(new WH_StockDetail(dDate, cSupplier, cSupplierNo,
	...
	public void updalo() {
		...
		httpUtils.send(HttpMethod.POST, Config.commitpurchase, params,
	...
	class myAsy extends AsyncTask<Void, Void, Boolean> {
		...
		protected Boolean doInBackground(Void... params) {
			...
			long rowid = db.delete("WH_StockDetail", "cSupplierNo=?",
					new String[] { No });
			if (rowid > 0) {
				return true;
